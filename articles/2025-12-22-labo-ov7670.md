...
レジスタの仕様などを記載したデータシートは、開発元のサイトには見当たりません。僕が参照したのは以下の PDF ファイルです[^resource]。特に、Implementation Guide は、混沌としたレジスタ群を機能ごとにカテゴリー分けしており、動作を理解するための参考になります。

[^resource]: ダウンロード元のサイトを示したかったのですが、公式ではないためいつリンクが切れるかわからないという不安がありました。ここでは、僕が管理している GitHub のリポジトリへのリンクを示します。

- [Advanced Information Preliminary Datasheet](https://raw.githubusercontent.com/ypsitau/zenn/main/resource/2025-12-22-labo-ov7670/OV7670_2006.pdf)
- [OV7670 Implementation Guide (V1.0)](https://raw.githubusercontent.com/ypsitau/zenn/main/resource/2025-12-22-labo-ov7670/OV7670%20Implementation%20Guide%20(V1.0).pdf)
