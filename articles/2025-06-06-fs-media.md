...
SDCard のルートディレクトリのファイル一覧を表示するプログラムを作成します。
...
int main()
{
    ...
    FAT::SDCard driveSD("Drive:", spi0, 10'000'000, {CS: GPIO5});
...
ファイルシステムを操作する API については[「pico-jxglib で Pico ボードにファイルシステムを実装してフラッシュメモリをフル活用する話」](https://zenn.dev/ypsitau/articles/2025-05-31-fs-flash#%E3%83%95%E3%82%A1%E3%82%A4%E3%83%AB%E3%82%B7%E3%82%B9%E3%83%86%E3%83%A0%E3%81%AE%E6%93%8D%E4%BD%9C)を参照してください。


### USB ストレージのファイルシステムを操作

USB ストレージのルートディレクトリのファイル一覧を表示するプログラムを作成します。
