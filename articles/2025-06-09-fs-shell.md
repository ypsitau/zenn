---
title: "pico-jxglib のシェルをファイルシステムで拡張する話 (自動補完つき)"
emoji: "🎉"
...
今回は、[pico-jxglib のシェル](https://zenn.dev/ypsitau/articles/2025-05-08-shell) の機能をファイルシステムで拡張する話です。自動補完機能も追加して、コマンドの入力を楽にします。また、ファイルシステムを操作するためのコマンドも追加して、ファイルシステムをより便利に使えるようにします。
