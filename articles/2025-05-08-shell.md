...
```text
test-Serial ver.0.1
Flash  0x10000000-0x10008510   34064
Vector 0x20000000-0x20000110     272
Data   0x20000110-0x20000B90    2688
Bss    0x20000B90-0x20001358    1992
Heap   0x20001358-0x20080000  519336
Stack  0x20080000-0x20082000    8192
```
...
- `Terminal& terminal` ... `Terminal` インスタンス。処理結果の表示を行います
- `int argc` ... 引数の数
