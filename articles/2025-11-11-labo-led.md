...
- Waveshare RP2040-Zero ボードの場合、DIN ピンは GPIO16 に接続されているので、以下のように設定します。
...
`display-ws2812` の `setup` サブコマンドで WS2812 の接続情報とディスプレイの形状を設定します。以下に、60 個の LED ストリップを GPIO2 に接続した例を示します。
