...
:::message
WiFi ルータによっては Pico ボードと相性が悪くて接続できない場合があります。ホスト PC が Windows であればモバイルホットスポット機能を使ってこれをアクセスポイントにすることができるので、こういった機能も試してみてください。セキュリティの面でいうと、この方法は WiFi ルータを使うよりも安全でおすすめです。
:::
