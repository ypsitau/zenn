---
title: "Pico ボードを Wi-Fi ネットワークに接続! Telnet サーバを動かして遠隔コマンド操作もしてみよう"
emoji: "🦁"
...
pico-jxgLABO を使うと、Pico W や Pico 2 W の Wi-Fi 機能を簡単に試すことができます。Wi-Fi ネットワークに接続してネットワークコマンドを実行したり、Telnet サーバを動かして遠隔でコマンド操作をしたりすることも可能です。
